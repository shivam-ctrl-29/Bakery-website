  ...
  return (
    <main className="page-in" style={{ flex: 1 }}>
      ...
      <section style={{ position: 'relative', height: 'calc(100vh - 77px)', minHeight: 560, overflow: 'hidden', background: '#16120D' }}>
        ...
        <div className="hero-corner" style={{ position: 'absolute', top: 0, left: 0, right: 0, display: 'flex', justifyContent: 'space-between', padding: '32px 48px' }}>
        ...
        {/* Headline block */}
        <div className="hero-pad" style={{ position: 'absolute', left: 0, right: 0, bottom: 0, padding: '0 48px 44px' }}>
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, fontSize: 'clamp(52px, 10.5vw, 168px)', lineHeight: 0.94, letterSpacing: '-0.02em', color: '#FBFAF6', margin: '0 0 32px' }}>
          ...
          <div className="hero-body r-stack" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <Link
                to="/menu"
                style={{ fontSize: 12, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#FBFAF6', border: '1px solid rgba(251,250,246,0.4)', padding: '15px 32px', textDecoration: 'none', transition: 'border-color 0.3s' }}
          ...
          {/* Meta strip — hidden on mobile */}
          <div className="hero-strip r-hide" style={{ borderTop: '1px solid rgba(251,250,246,0.22)', marginTop: 40, paddingTop: 22, display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32 }}>
        ...
        <div className="credo-track">
          {credoItems.map((item, i) => (
            <span key={i} style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
              <span style={{ fontSize: 10.5, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#B3A896', padding: '0 28px' }}>{item}</span>
      ...
      >
        <div className="r-stack" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 24, marginBottom: 56, flexWrap: 'wrap' }}>
          <div>
            <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 11, letterSpacing: '0.18em', color: '#A07C4F', margin: '0 0 22px' }}>( BESTSELLERS )</p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, fontSize: 'clamp(30px, 4.2vw, 60px)', lineHeight: 1.08, letterSpacing: '-0.015em', margin: 0, maxWidth: 640 }}>
        ...
        <div className="r-grid-1" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'start', marginBottom: 56 }}>
          <Link to="/menu" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
            <HoverImg src={tiramisu} alt="Tiramisu" style={{ aspectRatio: '4/3', marginBottom: 22 }} />
            <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 16, marginBottom: 10, flexWrap: 'wrap' }}>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(26px, 2.6vw, 38px)', margin: 0, lineHeight: 1 }}>Tiramisu</p>
              <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: '0.16em', color: '#B3A896', margin: 0, whiteSpace: 'nowrap' }}>№ 01 — THE SIGNATURE</p>
            </div>
            <p style={{ fontSize: 13, lineHeight: 1.8, color: '#8B8071', margin: 0 }}>
              Espresso-soaked, house-made eggless ladyfingers layered with silky mascarpone. The reason most people find us.
            </p>
          </Link>

          <Link to="/menu" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
            <HoverImg src={cookie} alt="Cookie 411" style={{ aspectRatio: '4/3', marginBottom: 22 }} />
            <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 16, marginBottom: 10, flexWrap: 'wrap' }}>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(26px, 2.6vw, 38px)', margin: 0, lineHeight: 1 }}>Cookie 411</p>
              <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: '0.16em', color: '#B3A896', margin: 0, whiteSpace: 'nowrap' }}>№ 02 — SWEET</p>
            </div>
            <p style={{ fontSize: 13, lineHeight: 1.8, color: '#8B8071', margin: 0 }}>
        ...
        <div className="r-stack" style={{ borderTop: '1px solid #E7E1D4', padding: '24px 0 0', display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 16 }}>
      ...
      {/* ── MANIFESTO ── */}
      <section ref={manifRef} style={{ background: '#F5F1E9', borderTop: '1px solid #E7E1D4', borderBottom: '1px solid #E7E1D4' }}>
        <div
          className="r-pad"
          style={{
            maxWidth: 1100,
      ...
      <section ref={ctaRef} style={{ background: '#16120D' }}>
        ...
        >
          <div>
            <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 11, letterSpacing: '0.18em', color: '#A07C4F', margin: '0 0 28px' }}>( RESERVATIONS )</p>
            <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, fontSize: 'clamp(32px, 4.5vw, 68px)', lineHeight: 1.08, letterSpacing: '-0.015em', color: '#FBFAF6', margin: 0 }}>
